...
$quote_list = [
    "Records relating to Shakespeare" => [
        "heading" => "Records relating to Shakespeare",
...
$audio_embed_list = [
    "A tourist’s guide to Shakespeare’s London" => [
        ...
        "transcript" => [
            "paragraph-1" => "Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna
             ...
             eget nullam.",
            "paragraph-2" => "Amet est placerat in egestas erat imperdiet. Sed felis eget velit aliquet sagittis id consectetur. Sit amet mattis vulputate enim nulla
            ...
            "paragraph-3" => "Mauris nunc congue nisi vitae suscipit tellus. Lacinia at quis risus sed vulputate. Interdum velit euismod in pellentesque. Velit dignissim
...
$content_block_list = [
    "Shakespeare's career" => [
        "heading" => "Shakespeare's career",
        "text" => [
            "paragraph-1" => "William Shakespeare, also known as the ‘Bard’, was born in Stratford-upon-Avon on April 23rd 1564. It is thought he married his wife, Anne Hathaway, in 1582, although we have no specific marriage certificate. He pursued a career as an actor, poet and dramatist in London.",
