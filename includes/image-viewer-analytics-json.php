<script>
    ...
    dataLayer = [{
        'contentGroup1': 'Image viewer', // The name of the content group - [Always has a value]
        ...
        'customDimension3': 'Image viewer', // This is the page type - [Always has a value]
        'customDimension4': '', // This is a semi-colon separated list of the related taxonomy topics where applicable. Empty string if not applicable.
